...
initialState stdGen map pics playerSprites ghostSprites highScores elapsedSeconds s = GameState { player = initialPlayer playerSprites spawnPosition,
                                                                                                  ...
                                                                                                  blinky = initialGhost (head ghostSprites) blinkyPosition blinkyHome Blinky 200,
                                                                                                  inky = initialGhost (ghostSprites !! 1) inkyPosition inkyHome Inky 1000,
                                                                                                  clyde = initialGhost (ghostSprites !! 2) clydePosition clydeHome Clyde 200,
                                                                                                  pinky = initialGhost (ghostSprites !! 3) pinkyPosition pinkyHome Pinky 300,

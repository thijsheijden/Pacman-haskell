...
initialState stdGen map pics playerSprites ghostSprites highScores elapsedSeconds s = GameState { player = initialPlayer playerSprites spawnPosition,
                                                                                                  ...
                                                                                                  inky = initialGhost (ghostSprites !! 1) inkyPosition inkyHome Inky 25,
                                                                                                  clyde = initialGhost (ghostSprites !! 2) clydePosition clydeHome Clyde 30,
                                                                                                  pinky = initialGhost (ghostSprites !! 3) pinkyPosition pinkyHome Pinky 40,
